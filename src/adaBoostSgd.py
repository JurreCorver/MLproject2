...
boostEps, boostAlp, boostModel = adaBoost(sgdBase, numBoost, trainingFeatures, trainingTargets)
adaBoostSgdPred, adaBoostSgdPredProb = adaBoostPredict(boostModel,boostAlp, numBoost, testingFeatures)
# csvFormatedOutput('../adaBoostSgdPredictedProb.csv', adaBoostSgdPredProb[:,1])
